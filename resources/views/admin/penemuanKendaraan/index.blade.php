                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped mb-0" id="datatable-default">
                            ...
                            <tbody>
                               <tr>
                               <td>1</td>
                               <td>Parkiyra RS Ratu Jaleha Posko 36</td>
                               <td>DA 4556 PAD</td>
                               <td> Supra X</td>
                               <td>Hitam</td>
                               <td>Udin</td>
                               ...
                               <td>082718683183</td>
                               <td>
                                            <a href="{{Route('penemuanKendaraanEdit')}}" class="btn btn-sm btn-primary m-1 text-white">
        ...
        <div class="modal-content">
            ...
            @csrf
                <div class="form-group ">
                        <label class="">Parkiran</label>
                        <select name="posko_id" id="" class="form-control">
                            <option value="">ambil dari parkiran</option>
                        </select>
                    </div>
                    <div class="form-group ">
