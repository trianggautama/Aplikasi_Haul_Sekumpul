...
<body>
    ...
    <div class="container">
     ...
     <hr>
        ...
        <br>
        <img style="margin-bottom:20px;" src="images/anggota/{{$data->foto}}" alt="" width="100%">
        <p style="margin:0px ; text-transform:uppercase;"><b>{{$data->nama}}</b></p>
        <p style="margin:0px; color:green">(Anggota {{$data->posko->nama_posko}})</p>
        <p style="margin:0px">No hp: {{$data->no_hp}}</p>
        </div>
