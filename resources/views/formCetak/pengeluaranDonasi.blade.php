...
<body>
    ...
    <hr>
        <div class="isi">
            <h2 style="text-align:center;">LAPORAN PENGELUARAN DONASI PERIODE HAUL {{\carbon\carbon::parse($haul->tanggal_mulai)->translatedFormat('Y')}}</h2> 
            <br>
            <table class="table table-bordered table-striped mb-0" id="datatable-default">
                            ...
                            <tbody>
                                ...
                                @endforeach
                                <tr>
                                    <td colspan="3">Sisa Saldo Anggaran</td>
                                    @php
                                        $donasi = $donasi->sum('besaran');
                                        $sisa = $donasi - $data->sum('besaran');
                                    @endphp
                                    <td>@currency($sisa),-</td>
                                </tr>
                            </tbody>
